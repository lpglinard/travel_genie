import 'dart:convert';
import 'lib/trip/models/autocomplete_models.dart';
...
void main() {
  ...
  try {
    ...
    for (int i = 0; i < response.suggestions.length; i++) {
      ...
      print('  Secondary text: "${prediction.secondaryText}" (should be empty)');
    ...
    assert(firstPrediction.secondaryText == ""); // Should be empty since no secondaryText in sample
