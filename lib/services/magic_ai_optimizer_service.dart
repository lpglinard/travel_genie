...
class MagicAiOptimizerService {
  ...
  Future<MagicAiOptimizationResult> optimizeTrip({
    ...
    if (random.nextInt(10) == 0) {
      throw MagicAiOptimizationException(
        'Network error occurred during optimization',
      );
    }
  ...
  List<String> _generateImprovements(OptimizationStrategy strategy) {
    ...
    switch (strategy) {
      case OptimizationStrategy.timeEfficient:
        ...
        improvements.addAll(
          _selectRandomItems(timeImprovements, 2 + random.nextInt(2)),
        );
        break;
      ...
      case OptimizationStrategy.costEffective:
        ...
        improvements.addAll(
          _selectRandomItems(costImprovements, 2 + random.nextInt(2)),
        );
        break;
      ...
      case OptimizationStrategy.experienceMaximizer:
        ...
        improvements.addAll(
          _selectRandomItems(experienceImprovements, 2 + random.nextInt(2)),
        );
        break;
    }
